...
const ButtonArrowTall = ({ text = "Text", onClick, href }: ButtonProps) => {
  return (
    <Link
      href={`/${href}`}
      className="flex align-middle bg-gradient-to-r from-[#3A3C3A] to-[#040504] pl-7 hover:opacity-80 rounded-full items-center transition-all duration-200 cursor-default text-white text-lg font-manrope font-medium tracking-tight"
    >
      {text}
