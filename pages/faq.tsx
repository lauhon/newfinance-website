...
const faqItemsGeneral = [
  {
    ...
    icon: "Kanban",
    text: "With NewFinance you can invest in Bitcoin and secure your financial future. Unfortunately, the current economic situation makes this necessary. Bitcoin is used by millions of people as an investment.",
    linkText: "",
    link: "",
    isExpanded: false,
  },
  ...
  },
  {
    ...
    icon: "Coins",
    text: "NewFinance is absolutely free for you during the beta. After the end of the beta, NewFinance remains free for all beta users.",
    linkText: "",
    link: "",
    isExpanded: false,
  },
